...
export default function Bar(){
    ...
    return <div className="flex items-center justify-between w-full py-3 h-[70px]">
        ...
        <div className="lg:flex hidden w-[35%] h-full rounded-[25px] justify-between items-center overflow-hidden shadow-[0px_14px_28px_rgba(0,0,0,0.25),_0px_10px_10px_rgba(0,0,0,0.22)]">
